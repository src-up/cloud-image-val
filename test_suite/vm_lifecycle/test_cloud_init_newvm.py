...
from lib import version_util
from lib.vm_lifecycle.base import UnSupportedAction
from parameterized import parameterized
from lib.vm_lifecycle.azure import AzurePublicIP
from lib.vm_lifecycle.azure import AzureNIC
from lib.vm_lifecycle.azure import AzureNicIpConfig
from lib.vm_lifecycle.azure import AzureImage
from lib.vm_lifecycle.azure import AzureNSG
...
""".format(self.rhel_branch, self.repopath, self.vm.rhel_ver, self.composepath))
    ...
    def test_cloudinit_provision_gen2_vm(self):
        ...
        from lib.utils_lib import get_public_key
